...
import com.example.healthapp.databinding.FragmentWaterListBinding
import java.util.*

class WaterListFragment : Fragment(), MyCustomDialogInterface {

    private var binding : FragmentWaterListBinding? = null
    private val memoViewModel: MemoViewModel by viewModels() // 뷰모델 연결
    private val adapter : RecordAdapter by lazy { RecordAdapter(memoViewModel) } // 어댑터 선언
